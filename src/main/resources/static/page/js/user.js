...
layui.config({
    ...
    form.verify({
        ...
        confirmPwd: function (value, item) {
            if ((!new RegExp($("#oldPwd").val()).test(value)) || ($("#oldPwd").val().length != value.length)) {
    ...
    form.on("submit(changePwd)", function (data) {
        ...
        // setTimeout(function () {
            ...
            console.log("**************" + username + currPwd + newPwd);
            ...
            $.ajax({
                ...
                type: "post",
                dataType: "json",
                data: {username: username, currPwd: currPwd, newPwd: newPwd},
