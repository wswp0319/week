...
public class StringUtil {
    ...
    public static String escapeDateToCn(Date date, String str1, String str2) {
        long nowTime = DateUtil.getNowTime();
        long distanceTime = nowTime - date.getTime();
        long day = distanceTime / 86400000L;
        long hour = distanceTime / 3600000L - day * 24L;
        long min = distanceTime / 60000L - day * 24L * 60L - hour * 60L;
        return day > 0L ? DateUtil.format(date) : (hour > 0L ? hour + str1 : (min > 0L ? min + str2 : 1 + str2));
    }
